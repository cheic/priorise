...
class AppLocalizationsFr extends AppLocalizations {
  ...
  @override
  String get navPriorise => 'Matrice';
  ...
  String get userGuideText =>
      'Bienvenue dans la philosophie Priorise. Voici 5 étapes pour reprendre le contrôle de votre temps :\n\n1. Définissez vos Rôles de Vie\nVous êtes bien plus que votre simple profession. Parent, créateur, ami, sportif... Déclarez vos différents Rôles. Chaque tâche que vous accomplirez sera reliée à une de ces facettes, garantissant un équilibre personnel sain.\n\n2. Les Grosses Pierres (La direction)\nPrenez 10 minutes chaque dimanche pour définir vos tâches essentielles de la semaine pour chaque rôle. Ce sont vos « Grosses Pierres ». Ce rituel garantit que vous avancez dans la bonne direction.\n\n3. Le Gravier (Tâches Ponctuelles)\nLe quotidien est fait de petites choses (le gravier) : répondre à un e-mail, une petite course... Ajoutez ces « Tâches Ponctuelles » dans votre Planification. L\'objectif est de vider votre esprit et de réduire votre charge mentale.\n\n4. La Matrice de Décision\nAu quotidien, classez et visualisez vos tâches dans les 4 zones de la Matrice :\n• Important et Urgent : Les crises à gérer immédiatement.\n• Important, Pas Urgent : La zone de progression (vos Grosses Pierres). C\'est le cœur de l\'application. Passez-y un maximum de temps.\n• Pas Important, Urgent : Les interruptions. À déléguer ou limiter.\n• Pas Important, Pas Urgent : Les distractions. À éliminer.\n\n5. Le Bilan\nPrenez un temps d\'arrêt régulier pour observer vos actions, ce qui a fonctionné et ce qui a dérapé.';
